...
myawesomemenu = {
   { "manual", safe_terminal .. " -e man awesome" },
...
menubar.utils.terminal = safe_terminal -- Set the terminal for applications that require it
-- }}}
...
clientkeys = awful.util.table.join(
    awful.key({ modkey, "Shift"   }, "Return",
      function (c)
        ...
        awful.util.spawn(terminal.." -d \""..path.."\"")
      end),
