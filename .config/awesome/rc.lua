...
-- naughty.notify({preset=critical,text=menubar.utils.lookup_icon("terminal")})
-- naughty.notify({preset=critical,text=menubar.utils.lookup_icon("smplayer")})
favoriteapps = {
                 ...
                 --{ "calc", "gnome-calculator", "/usr/share/icons/gnome/16x16/apps/accessories-calculator.png" },
                 { "gcstar", "gcstar", "/usr/share/pixmaps/gcstar.png" },
                 { "libreoffice", "soffice -writer", "/usr/share/icons/gnome/16x16/apps/libreoffice-writer.png" },
                 { "libreoffice -impress", "soffice -impress", "/usr/share/icons/gnome/16x16/apps/libreoffice-impress.png" },
...
mpdWidgetButtons = awful.util.table.join(
    ...
    awful.button({ }, 4, function () awful.util.spawn("mpc prev") vicious.force({ mpdwidget}) end),
    awful.button({ }, 5, function () awful.util.spawn("mpc next") vicious.force({ mpdwidget}) end),
